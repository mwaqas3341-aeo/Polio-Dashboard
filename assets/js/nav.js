const NAV_LINKS = [
  ...
  { href: "pages/team-targets.html", label: "Team targets (set by AIC)" },
  { href: "pages/team-plan.html", label: "Register totals (reference)" },
  { href: "pages/logistics.html", label: "Logistic plan (from targets)" },
